...
public class CartItem {
    ...
    public CartItem(UUID id, Cart cart, UUID productId, String productName, BigDecimal unitPrice, int quantity) {
        this(id, cart, productId, productName, unitPrice, quantity, null, null);
    }

    public CartItem(UUID id, Cart cart, UUID productId, String productName, BigDecimal unitPrice, int quantity, UUID selectedOptionId, String selectedOptionValue) {
        this.id = id;
        this.cart = cart;
